...
module.exports = {
    ...
    command: async function (msg, cmd, args) {
        let url = `https://opentdb.com/api.php?amount=1&encode=url3986&token=${token_trivia[msg.guild.id]}`
        ...
        if (body.response_code === 3) {
            ...
            url = `https://opentdb.com/api.php?amount=1&encode=url3986&token=${token_trivia[msg.guild.id]}`
            body = (await got(url, { json: true })).body
        }
