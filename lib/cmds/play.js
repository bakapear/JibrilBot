...
module.exports = {
    ...
    command: async function (msg, cmd, args) {
        ...
        if ("q" in data || "v" in data) {
            ...
            songs.push([id, body.items[0].snippet.title, body.items[0].snippet.thumbails.high ? body.items[0].snippet.thumbnails.high.url : "https://puu.sh/BdcCE.jpg", body.items[0].snippet.thumbnails.medium ? body.items[0].snippet.thumbnails.medium.url : "https://puu.sh/BdcBr.jpg"]);
        }
            ...
            do {
                ...
                for (let i = 0; i < body.items.length; i++) {
                    ...
                    songs.push([body.items[i].snippet.resourceId.videoId, body.items[i].snippet.title, body.items[i].snippet.thumbails.high ? body.items[i].snippet.thumbnails.high.url : "https://puu.sh/BdcCE.jpg", body.items[i].snippet.thumbnails.medium ? body.items[i].snippet.thumbnails.medium.url : "https://puu.sh/BdcBr.jpg"]);
                }
