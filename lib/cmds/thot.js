    ...
    command: async function (msg, cmd, args) {
        try {
            ...
            for (let i = 0; i < data.faces.length; i++) {
                ...
                let parts = [
                    await jimp.read("./lib/data/assets/thot/left_ear.png"),
                    await jimp.read("./lib/data/assets/thot/right_ear.png"),
                    await jimp.read("./lib/data/assets/thot/nose.png"),
                    await jimp.read("./lib/data/assets/thot/tongue.png")
                ];
            ...
            let file = `./lib/data/temp/thot_${msg.author.id}.jpg`;
