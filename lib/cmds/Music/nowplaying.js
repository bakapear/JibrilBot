...
module.exports = {
    ...
    command: async function (msg, cmd, args) {
        ...
        let endtime = ""
        if (voice[msg.guild.id].queue[0].duration) endtime = " - " + voice[msg.guild.id].queue[0].duration
        let title = "Now Playing (" + miliToTime(voice[msg.guild.id].disp.time) + endtime + ")"
