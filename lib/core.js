...
checks = [
	...
	msg => { //2
		if (!msg.member.voiceChannel && !msg.author.bot) {
...
bot.on("message", async msg => {
	...
	if (!(msg.content.startsWith("$") || msg.content.startsWith(".") || msg.content.startsWith(",") || msg.content.startsWith("-"))) return;
	if (msg.author.bot && !msg.content.startsWith("$")) return
	else if (msg.content.startsWith("$")) msg.content = msg.content.substr(1)
